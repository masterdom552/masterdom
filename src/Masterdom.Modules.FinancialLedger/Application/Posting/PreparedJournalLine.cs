...
internal sealed class PreparedJournalLine
{
    public PreparedJournalLine(
        string lineId,
        string accountCode,
        string accountName,
        ...
        IReadOnlyDictionary<string, string>? metadata = null)
    {
        ...
        if (amount <= 0)
        {
            throw new ArgumentOutOfRangeException(nameof(amount), "Journal line amount must be greater than zero.");
        }
