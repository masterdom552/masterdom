...
internal sealed class BusinessJournalNumberGenerator : IJournalNumberGenerator
{
    private readonly JournalNumberingOptions _options;

    public BusinessJournalNumberGenerator(JournalNumberingOptions? options = null)
    {
