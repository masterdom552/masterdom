...
/// <summary>
/// Represents a government-issued document belonging to a person.
/// </summary>
public sealed class GovernmentDocument : ValueObject
{
    private GovernmentDocument(
        string type,
    ...
    /// <summary>
    /// Gets whether this is the primary document of its type.
    /// </summary>
    public bool IsPrimary { get; }

    /// <summary>
    /// Gets whether the document has been verified.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new government document.
    /// </summary>
    public static GovernmentDocument Create(
        string type,
        string documentNumber,
    ...
    /// </summary>
    public GovernmentDocument Verify()
    {
        if (IsVerified)
            return this;
    ...
    /// </summary>
    public GovernmentDocument MakePrimary()
    {
        if (IsPrimary)
            return this;
