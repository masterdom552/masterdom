...
internal sealed class PlatformMetadataDefinitionConfiguration
    : IEntityTypeConfiguration<PlatformMetadataDefinitionEntity>
{
    public void Configure(EntityTypeBuilder<PlatformMetadataDefinitionEntity> builder)
    {
        builder.ToTable("platform_metadata_definitions");
