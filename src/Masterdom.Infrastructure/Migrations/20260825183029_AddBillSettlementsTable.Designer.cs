...
namespace Masterdom.Infrastructure.Migrations
{
    ...
    [Migration("20260825183029_AddBillSettlementsTable")]
    partial class AddBillSettlementsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Masterdom.Core.Identity.Entities.Credential.Credential", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Masterdom.Core.Identity.Entities.DelegatedAuthority.DelegatedAuthority", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DelegatedToUserId", "Status");

                    b.HasIndex("DelegatedToUserId", "EffectiveFromUtc", "EffectiveToUtc");

                    b.ToTable("DelegatedAuthority", "identity");
                });
            ...
            modelBuilder.Entity("Masterdom.Infrastructure.Persistence.FinancialLedger.PersistedPreparedJournalEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Masterdom.Infrastructure.Persistence.Settlement.BillSettlement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("bill_settlements", (string)null);
                });
            ...
            modelBuilder.Entity("Masterdom.Modules.FinancialLedger.Domain.Entities.FinancialLedger.Ledger", b =>
                {
                    b.OwnsMany("Masterdom.Modules.FinancialLedger.Domain.Entities.FinancialLedger.LedgerAccount", "Accounts", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.Property<DateTime>("OpenedAtUtc")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("opened_at_utc");

                            b1.Property<Guid>("ledger_id")
                                .HasColumnType("uuid");
                            ...
                            b1.HasIndex("ledger_id");

                            b1.ToTable("ledger_accounts", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ledger_id");
                        });

                    b.OwnsMany("Masterdom.Modules.FinancialLedger.Domain.Entities.FinancialLedger.LedgerSnapshot", "Snapshots", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("ledger_snapshots", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ledger_id");
                        });

                    b.OwnsMany("Masterdom.Modules.FinancialLedger.Domain.Entities.FinancialLedger.LedgerTransaction", "Transactions", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.Property<string>("JournalNumber")
                                .IsRequired()
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("journal_number");

                            b1.Property<DateOnly>("PostingDate")
                                .HasColumnType("date")
                                .HasColumnName("posting_date");

                            b1.Property<string>("PostingReference")
                                .IsRequired()
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("posting_reference");

                            b1.Property<string>("PostingStatus")
                                .IsRequired()
                                .HasMaxLength(50)
                                .HasColumnType("character varying(50)")
                                .HasColumnName("posting_status");

                            b1.Property<Guid?>("ReversedTransactionId")
                                .HasColumnType("uuid")
                            ...
                            b1.HasIndex("JournalNumber")
                                .IsUnique()
                                .HasDatabaseName("ux_ledger_transactions_journal_number");

                            b1.HasIndex("PostingReference")
                                .IsUnique()
                            ...
                            b1.ToTable("ledger_transactions", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ledger_id");

                            b1.OwnsMany("Masterdom.Modules.FinancialLedger.Domain.Entities.FinancialLedger.JournalEntry", "JournalEntries", b2 =>
                                {
                                    b2.Property<int>("id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("integer");
                                    ...
                                    b2.Property<string>("AccountReference")
                                        .IsRequired()
                                        .HasColumnType("jsonb")
                                        .HasColumnName("account_reference");
                                    ...
                                    b2.Property<int>("ledger_transaction_id")
                                        .HasColumnType("integer");
                                    ...
                                    b2.HasIndex("ledger_transaction_id");

                                    b2.ToTable("journal_entries", (string)null);

                                    b2.WithOwner()
                                        .HasForeignKey("ledger_transaction_id");
                                });

                            b1.Navigation("JournalEntries");
                        });

                    b.OwnsMany("Masterdom.Modules.FinancialLedger.Domain.Entities.FinancialLedger.LedgerVersion", "Versions", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("ledger_versions", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ledger_id");
                        });

                    b.OwnsMany("Masterdom.Modules.FinancialLedger.Domain.Entities.FinancialLedger.PostingBatch", "PostingBatches", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.Property<string>("TransactionIds")
                                .IsRequired()
                                .HasColumnType("jsonb")
                            ...
                            b1.ToTable("posting_batches", (string)null);
