...
/// <summary>
/// Domain fact emitted when a party role becomes active.
/// </summary>
public sealed class PartyRoleActivatedDomainEvent : DomainEvent
{
    public PartyRoleActivatedDomainEvent(PartyId partyId, PartyRoleAssignmentId roleAssignmentId, PartyRoleType roleType)
    {
