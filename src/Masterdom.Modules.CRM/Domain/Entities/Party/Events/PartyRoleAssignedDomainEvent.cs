...
/// <summary>
/// Domain fact emitted when a party role is assigned.
/// </summary>
public sealed class PartyRoleAssignedDomainEvent : DomainEvent
{
    public PartyRoleAssignedDomainEvent(PartyId partyId, PartyRoleAssignmentId roleAssignmentId, PartyRoleType roleType)
    {
